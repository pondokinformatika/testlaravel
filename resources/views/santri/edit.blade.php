<form action="{{url('santri/update')}}" method="post">
	...
	Jenis Kelamin : 
	<input type="radio" name="jenis_kelamin" value="L" {{($santri->jenis_kelamin == 'L') ? 'checked':''}}> Laki - laki |

	<input type="radio" name="jenis_kelamin" value="P"{{($santri->jenis_kelamin == 'P') ? 'checked':''}}> Perempuan <br>
